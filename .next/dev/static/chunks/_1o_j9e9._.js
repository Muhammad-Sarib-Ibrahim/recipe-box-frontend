...
function HomePage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (mode === "register") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(email, password);
            }
            const { access_token } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
            login(access_token);
            router.push("/recipes");
        } catch (err) {
...
_s(HomePage, "+eAa0wKcIt1bwGHwHSf3u0YS+6s=", false, function() {
    return [
...
//# sourceMappingURL=_1o_j9e9._.js.map