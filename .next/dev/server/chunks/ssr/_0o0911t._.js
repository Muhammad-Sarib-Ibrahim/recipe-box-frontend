...
"[project]/app/recipes/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RecipeDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!token) return;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRecipe"])(token, recipeId).then((data)=>{
            setRecipe(data);
            setTitle(data.title);
            setIngredients(data.ingredients);
            setInstructions(data.instructions);
        }).catch((err)=>setError(err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] && err.status === 404 ? "Recipe not found." : "Could not load this recipe.")).finally(()=>setIsLoading(false));
    }, [
        token,
        recipeId
    ]);
    async function handleSave() {
        ...
        setError(null);
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateRecipe"])(token, recipeId, {
                title,
                ingredients,
                instructions
            });
    ...
    async function handleDelete() {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteRecipe"])(token, recipeId);
            router.push("/recipes");
        } catch  {
...
//# sourceMappingURL=_0o0911t._.js.map